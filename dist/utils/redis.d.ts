...
export declare function addUserToRoom(roomId: string, userId: string): Promise<void>;
export declare function removeUserFromRoom(roomId: string, userId: string): Promise<void>;
export declare function getOnlineUsers(roomId: string): Promise<string[]>;
export declare function isRateLimited(key: string, limit: number, windowSec: number): Promise<boolean>;
export declare function cacheRoomMessages(roomId: string, messages: any[], ttlSec?: number): Promise<void>;
export declare function getCachedRoomMessages(roomId: string): Promise<any[] | null>;
export declare function cacheUser(userId: string, user: any, ttlSec?: number): Promise<void>;
export declare function getCachedUser(userId: string): Promise<any | null>;
export declare function publishToChannel(channel: string, message: any): Promise<void>;
export declare function subscribeToChannel(channel: string, handler: (msg: any) => void): Promise<void>;
